...
\resumeEntryP{I love active problem-solving, and \resumeBf{tinkering} around with an ever-evolving project until it is exactly right. I enjoy learning \& seeing how technology can be applied to \resumeBf{improve human lives}.}
...
\resumeEntryStart
\resumeEntryS
{Other Languages}{I also have experience in \resumeBf{C/C++}, \resumeBf{Python}, \resumeBf{Java}, and \resumeBf{MATLAB}.}
\resumeEntryEnd
