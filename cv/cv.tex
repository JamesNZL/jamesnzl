...
\resumeEntryStart
\resumeEntryE{I’m \resumeBf{chasing opportunities} to grow my love for everything from \resumeBf{analogue electronics} to \resumeBf{full-stack web development}.}

\resumeEntryP{I love active problem-solving, and \resumeBf{tinkering} around with an ever-evolving project until it's exactly right. I enjoy learning \& seeing how technology can be applied to \resumeBf{improve human lives}---whether through software, hardware, or a \resumeBf{beautiful combination of both}.}
...
\resumeItemListStart
\resumeItem{
	\resumeIt{I’m a natural problem solver, and \resumeBf{apply} my strong \resumeBf{logical thinking} to challenging situations. I leave things \resumeBf{better than I found them}, working methodically to arrive at an optimal solution.}
}
\resumeItem{
...
\resumeItemListStart
\resumeItem{
	\resumeIt{I’m an effective communicator with an aptitude for \resumeBf{breaking down challenging concepts}.}
}
\resumeItem{
...
\resumeItemListStart
\resumeItem{
	\resumeIt{I’m passionate about intent-based leadership and \resumeBf{understanding} each member’s \resumeBf{strengths and weaknesses}---I strongly believe the whole is greater than the sum of its parts.}
}
\resumeItem{
...
\resumeItemListStart
\resumeItem{
	\resumeIt{I strive to \resumeBf{be an asset} to any team, and try to morph into whatever role is in demand. I’m often counted on for my punctuality and reliability---\resumeBf{I don’t make promises I can’t keep}.}
}
\resumeItem{
