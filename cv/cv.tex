...
\resumeEntryStart
\resumeEntryS
{Other Languages}{I am also experienced with \resumeBf{C/C++}, and have familiarity with \resumeBf{VHDL}, \resumeBf{C\#}, \resumeBf{Python}, \resumeBf{Java}, and \resumeBf{MATLAB}.}
\resumeEntryEnd
...
\resumeItem {\resumeBf{3800+ unique users} in \resumeBf{twelve months}}
...
\resumeItemListEnd
\resumeItemListStartColumns{3}
\resumeItem[\bulletstyleii] {Lecturer's Choice for \resumeBf{Top Team}}
\resumeItem[\bulletstyleii] {Git and GitHub}
