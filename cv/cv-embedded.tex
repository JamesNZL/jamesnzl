...
\resumeEntryStart
\resumeEntryE{I am \resumeBf{chasing an internship} to grow my passion for \resumeBf{analogue electronics} and \resumeBf{embedded systems}.}
...
\resumeItem {Cumulative GPA of 8.3/9.0 (\resumeBf{A}--\resumeBf{A+})}
...
\resumeItemListStart
\resumeItem {Writing \resumeBf{C/C++ firmware} on a new STM32U585 \resumeBf{ARM} development board}
...
\resumeItem {Familiarity with \resumeBf{LTspice}, Microchip Studio, Proteus VSM, and \resumeBf{Altium Designer}}
\resumeItem {Experience writing \resumeBf{firmware} for \resumeBf{Atmel megaAVR} and \resumeBf{ARM Cortex-M33}}
\resumeItemListEnd
\resumeEntryEnd
...
\resumeItem {\resumeBf{6100+ contributions} accrued over the past \resumeBf{5 years}}
\resumeItemListEnd
\resumeEntryEnd

\resumeEntryStart
\resumeEntryS
{Other Languages}{I am also highly proficient in \resumeBf{TypeScript/JavaScript}, and have familiarity with \resumeBf{VHDL}, \resumeBf{C\#}, \resumeBf{Python}, \resumeBf{Java}, and \resumeBf{MATLAB}.}
\resumeEntryEnd
...
\resumeEntryTSDL
{Flappy Bird}{2023}
{\href{https://jamesnzl.xyz/compsys305-flappy-bird}{jamesnzl.xyz/compsys305-flappy-bird}}{The University of Auckland}
\resumeItemListStart
\resumeItem {An \resumeBf{FPGA implementation} of Flappy Bird built in a \resumeBf{team of three}}
\resumeItem {Played on a \resumeBf{Cyclone V FPGA} with a PS/2 mouse, DIP switches, and pushbuttons}
\resumeItemListEnd
\resumeItemListStartColumns{3}
\resumeItem[\bulletstyleii] {Git and GitHub}
\resumeItem[\bulletstyleii] {VHDL}
\resumeItem[\bulletstyleii] {Altera Quartus Prime}
\resumeItemListEndColumns
\resumeEntryEnd
...
\resumeEntryP{
  Duleepa invited me to be a COMPSYS 209 \resumeBf{Teaching Assistant} and to assist with his \resumeBf{Smart Car workshop} at Mānawa Mai \resumeBf{Open Day}, based on my \resumeBf{technical proficiency} and \resumeBf{communication skills}.
}
\resumeEntryEnd
