...
\resumeEntryStart
\resumeEntryE{I am \resumeBf{chasing opportunities} to grow my love for \resumeBf{analogue electronics} and \resumeBf{embedded systems}.}
...
\resumeItemListStart
\resumeItem{
  I am a natural problem solver, and \resumeBf{apply} my strong \resumeBf{logical thinking} to challenging situations. I leave things \resumeBf{better than I found them}, working methodically to arrive at an optimal solution.
}
\resumeItemListEnd
...
\resumeItemListStart
\resumeItem{
  I am passionate about intent-based leadership and \resumeBf{understanding} each member's \resumeBf{strengths and weaknesses}---I strongly believe the whole is greater than the sum of its parts.
}
\resumeItemListEnd
...
\resumeItemListStart
\resumeItem{
  I strive to \resumeBf{be an asset} to any team, and try to morph into whatever role is in demand. I am often counted on for my punctuality and reliability---\resumeBf{I do not make promises I cannot keep}.
}
\resumeItemListEnd
\resumeEntryEnd
...
\resumeEntryStart
\resumeEntryS
{Other Languages}{I am also highly proficient in \resumeBf{TypeScript/JavaScript}, and have limited experience in \resumeBf{Python}, \resumeBf{Java}, and \resumeBf{MATLAB}.}
\resumeEntryEnd
