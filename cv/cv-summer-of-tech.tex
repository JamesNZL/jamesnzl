...
\resumeEntryStart
\resumeEntryE{I am \resumeBf{chasing opportunities} to grow my love for everything from \resumeBf{analogue electronics} to \resumeBf{full-stack web development}.}
...
\resumeEntryP{
  James has been a \resumeBf{significant mentor} to me, and has heavily \resumeBf{guided} my development whilst a member of the NZCF.
}
\resumeEntryEnd
...
\resumeEntryP{
  Rebecca was my Year 13 Calculus teacher, and is one of the \resumeBf{most influential} teachers I have ever had.
}
\resumeEntryEnd
...
\resumeEntryP{
  Matua Johnny was my Te Reo Māori \resumeBf{kaiako} \& subsequent \resumeBf{form teacher}, and is another teacher that has played a massively pivotal role in my life.
}
\resumeEntryEnd
